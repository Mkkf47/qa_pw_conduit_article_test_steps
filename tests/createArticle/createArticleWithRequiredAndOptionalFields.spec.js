...
test('Create an article with required and optional fields', async () => {
  ...
  await createArticlePage.fillArticleFormBody(article.body);
  await createArticlePage.fillArticleFormTag(article.tags);
  await createArticlePage.clickPublishArticleButton();
  await createArticlePage.assertArticleTitleIsCorrect(article.title);
  await createArticlePage.assertArticleBodyIsCorrect(article.body);
  await createArticlePage.assertArticleTagsAreCorrect(article.tags);
});
